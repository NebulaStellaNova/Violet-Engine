package violet.states.menus.substates;
...
class ModMenuSubState extends FlxSubState {
    ...
    override public function create() {
        ...
        modInfoBox = new NovaSprite(Paths.image("menus/modsmenu/modInfoPanel"));
        ...
        infoSeperator = new NovaSprite(Paths.image("menus/modsmenu/modInfoSeperator"));
        ...
        for (i=>mod in Modding.availableMods) {
            ...
            var iconBox = new NovaSprite(Paths.image("menus/modsmenu/iconBox"));
            icon.add(iconBox);
        ...
        tagImage = new NovaSprite(Paths.image("menus/modsmenu/tags/example"));
        ...
        statusText = new NovaSprite(Paths.image("menus/modsmenu/enabled"));
        add(statusText);
    ...
    function exit() {
		...
		FlxTween.tween(MainMenu.bg_static, {x: 0 }, 0.5*2, { ease: FlxEase.quadInOut });
