...
class Constants {
	...
	public static final COMMIT_INDEX:Int = Std.parseInt(Compiler.getDefine('COMMIT_INDEX'));
	public static final GITHUB_BRANCH:String = Compiler.getDefine('GITHUB_BRANCH').toUpperCase();
	...
	public static final ENGINE_SUFFIX:String = 'beta';
	 ...
	 */
	public static var DEFAULT_HEALTH_GAIN:Float = 0.01;

	/**
	 * Health you lose from missing a note.
	 */
	public static var DEFAULT_HEALTH_LOSS:Float = 0.05;
