...
class HealthBar extends FlxSpriteGroup {
    ...
    function get_leftColor():FlxColor {
        return left.color;
    }
    function set_leftColor(value:FlxColor) {
        return left.color = value;
    }

    public var rightColor(get, set):FlxColor;
    function get_rightColor():FlxColor {
        return right.color;
    }
    function set_rightColor(value:FlxColor) {
        return right.color = value;
    }
