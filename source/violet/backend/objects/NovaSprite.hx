...
class NovaSprite extends FlxSprite {
	...
	public function addAnim(name:String, prefix:String, ?offsets:Array<Float>, fps:Int = 24, looped:Bool = false) {
		this.animation.addByPrefix(name, prefix, fps, looped);
		this.offsets.set(name, offsets != null ? [-offsets[0], -offsets[1]] : [0, 0]);
	}

	public function addAnimIndices(name:String, prefix:String, indices:Array<Int>, ?offsets:Array<Float>, fps:Int = 24, looped:Bool = false) {
